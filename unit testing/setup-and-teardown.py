...
# A test fixture is a piece that constructs and configures an object or system under test
...
class TestRestaurant(unittest.TestCase):
    ...
    def test_summary(self):
        self.assertEqual(self.golden_palace.summary(), "This restaurant is owned by Jackie and is located at New York")
